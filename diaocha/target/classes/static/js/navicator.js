    ...
    function  loadPage() {
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(url == "user"){
                    userPage.initPage('0');//初始页面信息
                }
                if(url == "product"){
                	productPage.initPage('0');
                }
                if(url == "producttype"){
                	productTypePage.initPage('0');
                }
                if(url == "deliveryorder"){
                	deliveryOrderPage.initPage('0');
                }
                
                if(url == "machine"){
                	machinePage.initPage('0');
                }
                
                if(url == "ingredient"){
                	ingredientPage.initPage('0');
                }
                
                if(url == "purchaseorder"){
                	purchaseOrderPage.initPage('0');
                }
                
                if(url == "machine_task"){
                	machineTaskPage.initPage('0');
                }
                ...
                if(url == "produce_detail"){
                	produceDetailPage.initPage('0');
                }
            }
        });
    }
