...
public class CustomResult implements PropertyFilter{
	 ...
	 */
	public CustomResult(String[] fields) {
		this.fields = fields; 
	}
	 ...
	 * @param fields	忽略属性名称数组
	 */
	public CustomResult(boolean ignoreColl, String[] fields) {
		this.fields = fields;
	 ...
	 * @param ignoreColl 是否忽略集合
	 */
	public CustomResult(boolean ignoreColl) {
		this.ignoreColl = ignoreColl; 
	}
